...
namespace Gwards.DAL.Migrations
{
    ...
    [Migration("20240915221649_AddNftPassport")]
    partial class AddNftPassport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.NftPassport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.Quests.GameQuestEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 9, 15, 22, 16, 49, 173, DateTimeKind.Utc).AddTicks(5230),
                            Description = "",
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.Quests.MintQuestEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 9, 15, 22, 16, 49, 173, DateTimeKind.Utc).AddTicks(5220),
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.SubscribeQuestEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 15, 22, 16, 49, 173, DateTimeKind.Utc).AddTicks(5170),
                            Description = "Go to our discord server and text the code word \"Let's Play\" to the bot to get the reward!",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 9, 15, 22, 16, 49, 173, DateTimeKind.Utc).AddTicks(5180),
                            Description = "",
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.NftPassport", b =>
                {
                    b.HasOne("Gwards.DAL.Entities.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("Gwards.DAL.Entities.NftPassport", "PaymentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Gwards.DAL.Entities.UserEntity", "User")
                        .WithOne("Passport")
                        .HasForeignKey("Gwards.DAL.Entities.NftPassport", "UserId")
            ...
            modelBuilder.Entity("Gwards.DAL.Entities.Payment", b =>
                {
                    b.HasOne("Gwards.DAL.Entities.Transaction", "Transaction")
                        .WithOne()
                        .HasForeignKey("Gwards.DAL.Entities.Payment", "TransactionId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
